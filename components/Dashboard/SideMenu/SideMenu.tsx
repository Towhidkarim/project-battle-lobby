...
const SideMenu = ({
  ...
  return (
    <ScrollArea className='h-svh'>
      <TabsList className='relative flex flex-col justify-start py-8 items-center min-h-full'>
        <Logo />
        <span className='h-10' />
        ...
        <div className='flex flex-col w-full justify-start items-center'>
          ...
          <Button
            onClick={() => signOut()}
            variant='ghost'
            className='mt-10 gap-3 bottom-4 h-12 w-3/5 inline-flex justify-start px-10 text-base font-light rounded-xl mx-auto'
          >
            <span className='scale-125'>
              <FaSignOutAlt />
            </span>
