...
export default function Page() {
  return (
    <main className='min-h-screen bg-background w-screen'>
      <Navbar />
      <p className='max-w-prose mx-auto text-muted-foreground text-center'>
        {/* prettier-ignore-start */}
        Terms and Conditions Last updated: February 26, 2024 Please read these
        ...
        authority. Country refers to: Bangladesh Company (referred to as either
        "the Company", "We", "Us" or "Our" in this Agreement) refers to Battle
        Lobby LLC, 189 herming road, Bucharest, Romania. Device means any device
        ...
        help of the Terms and Conditions Generator. Third-party Social Media
        ...
        included or made available by the Service. Website refers to Battle
        Lobby, accessible from www.battlelobby.com You means the individual
        ...
        of the law of the country in which You are resident. United States Legal
        Compliance You represent and warrant that (i) You are not located in a
        country that is subject to the United States government embargo, or that
        ...
        these Terms shall not affect a party's ability to exercise such right or
